...
model_file_url = 'https://drive.google.com/uc?export=download&id=11a90cp1dpY-cSSh9zpHGXoqk3KAfbEAN'
model_file_name = 'simple_cnn_weights'
...
IMG_FILE_SRC = '/tmp/saved_image.jpg'
...
async def setup_model():
    ...
    #model = VGG16(weights='imagenet') # COMMENT, IF you have Custom trained model
    return model
